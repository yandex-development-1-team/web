import{r as b,j as e,a as S}from"./index-CWy5ZKgh.js";import{B as I}from"./Button-B2DytFO2.js";const A=({leftLabel:s,rightLabel:d,onToggle:r,className:g})=>{const[o,x]=b.useState("left"),n=v=>{x(v),r(v)},h=`
    flex
    flex-1
    items-center
    justify-center
