import{r as b,j as e,d as S}from"./index-Ch1llI3y.js";import{B as I}from"./Button-BoP-6OM5.js";import"./index-B9MR_GTO.js";const A=({leftLabel:s,rightLabel:i,onToggle:r,className:g})=>{const[o,x]=b.useState("left"),n=v=>{x(v),r(v)},h=`
    flex
    flex-1
    items-center
    justify-center
  ...
  `,c="rounded-tl-[8px] rounded-bl-[8px]",u="rounded-tr-[8px] rounded-br-[8px]";return e.jsxs("div",{className:`flex cursor-pointer h-full ${g}`,children:[e.jsxs("button",{type:"button",className:`
        ...
        `,children:[e.jsxs("div",{className:`
          ...
          `,children:[e.jsx(A,{className:"w-[562px]! mr-[20px] min-w-[488px]",leftLabel:"Настройка уровня доступа",rightLabel:"Настройка текстов",onToggle:h}),s!=="roleSelection"&&e.jsxs("div",{children:[e.jsx(I,{label:"Отменить",variant:"secondary",onClick:k,className:"w-[168px] mr-[20px] min-h-[46px]"}),e.jsx(I,{label:"Сохранить",onClick:w,className:"w-[168px] min-h-[46px]"})]})]}),s==="roleSelection"&&e.jsx("div",{className:"mt-[32px]",children:y.map((t,a)=>e.jsxs("button",{type:"button",className:`
                ...
                bg-white
                cursor-pointer
              `,onClick:m,children:[e.jsxs("div",{className:"flex flex-col items-start",children:[e.jsx("span",{className:"text-h3 text-text mt-[-3px]",children:y.find(t=>t.id===r)?.name}),e.jsx("span",{className:"text-h4sb text-text-grey-dark mt-[-3px]",children:y.find(t=>t.id===r)?.description})]}),e.jsx(S,{className:"w-[23px] text-text-grey-dark mr-[9px] rotate-180"})]}),e.jsx("div",{className:"bg-white rounded-[8px] flex-1 p-[20px]",children:e.jsx("div",{className:"flex flex-col flex-wrap content-start [@media(min-width:1220px)]:max-h-[616px]",children:E.map((t,a)=>{let l;switch(a){case 1:l="mb-[12px]";break;case 4:l="mb-[40px]";break;default:l="mb-[20px]"}return e.jsxs("div",{className:`${l} min-w-[462px] pl-[20px] `,children:[e.jsx("h5",{className:"text-h5 h-[40px] mb-[12px] flex items-center",children:t.name}),e.jsx("div",{className:"flex flex-col gap-[8px]",children:N.filter(d=>d.groupId===t.id).map((d,j)=>e.jsxs("div",{className:"h-[40px] ml-[40px] flex items-center gap-[12px]",children:[e.jsx(F,{checked:o[d.id],onChange:f=>B(d.id,f)}),e.jsx("span",{className:"text-h5",children:d.name})]},j))})]},a)})})})]})]})]})},L=V;export{L as Component};
