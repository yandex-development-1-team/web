import{r as f,j as e,S}from"./index-DVTBt0cW.js";const A=({leftLabel:s,rightLabel:d,onToggle:r,className:u})=>{const[i,c]=f.useState("left"),o=m=>{c(m),r(m)},p=`
    flex
    flex-1
    items-center
    justify-center
